...
export const siteMetadata: Metadata = {
  ...
  metadataBase: new URL("https://franckchapelon.com"),
  alternates: {
    canonical: "/",
    languages: {
      "fr-FR": "/fr",
  ...
  openGraph: {
    type: "website",
    locale: "fr_FR",
    url: "https://franckchapelon.com",
    siteName: "Franck Chapelon Développeur Web Freelance",
    title: "Franck Chapelon - Développeur Web Freelance",
    description:
      "Portfolio et services de Franck Chapelon, développeur web freelance en Aquitaine",
    images: [
      {
        url: "https://franckchapelon.com/_next/image?url=%2Flunette.webp&w=640&q=85",
        width: 2292,
        height: 2865,
